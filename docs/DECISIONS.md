...
**実体**: `frontend-public/src/styles/global.css` と `frontend-admin/src/styles/global.css`（トークンの実値と書体、覆いの見た目）、`frontend-public/src/layouts/BaseLayout.astro`（書体の読み込みと覆いの出し外し）、#228（クラスを出力しない描画）。

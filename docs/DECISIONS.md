...
紹介記事の見出し・公開日・タグに続き、**作品の基本情報・概要 → 試聴プレイヤー → 記事本文 → 曲目 → イベント情報（日時・会場・スペース等）→ 頒布価格**を表示する。記事本文は作品紹介の前置きとして、プレイヤーの後ろ、トラックリストの前に置く。未設定の区画は省略する。作品ページは同じ作品描画を使い、記事本文と頒布価格を持たない（価格の表示先は#349を維持）。

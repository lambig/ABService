...
class ArtistCreditNameTest {
    ...
    void testCreateValidName() {
        final ArtistCreditName name = new ArtistCreditName("Foo Bar");
    ...
    void testCreateNameWithJapanese() {
        final ArtistCreditName name = new ArtistCreditName("東方アレンジ");
    ...
    void testCreateNameWithFeaturing() {
        final ArtistCreditName name = new ArtistCreditName("Artist A feat. Artist B");
    ...
    void testCreateNameMaxLength() {
        final String maxLengthName = "a".repeat(255);
        final ArtistCreditName name = new ArtistCreditName(maxLengthName);
    ...
    void testEquivalentToSame() {
        final ArtistCreditName name1 = new ArtistCreditName("Foo Bar");
        final ArtistCreditName name2 = new ArtistCreditName("Foo Bar");
    ...
    void testEquivalentToDifferent() {
        final ArtistCreditName name1 = new ArtistCreditName("Artist A");
        final ArtistCreditName name2 = new ArtistCreditName("Artist B");
    ...
    void testEquality() {
        final ArtistCreditName name1 = new ArtistCreditName("Foo Bar");
        final ArtistCreditName name2 = new ArtistCreditName("Foo Bar");
        final ArtistCreditName name3 = new ArtistCreditName("Different Name");

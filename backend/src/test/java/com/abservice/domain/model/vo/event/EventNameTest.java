...
class EventNameTest {
    ...
    void testCreateValidName() {
        final EventName name = new EventName("コミックマーケット103");
    ...
    void testCreateNameWithSeason() {
        final EventName name = new EventName("M3-2024春");
    ...
    void testCreateNameMaxLength() {
        ...
        final EventName name = new EventName(maxLengthName);
    ...
    void testEquivalentToSame() {
        final EventName name1 = new EventName("コミケ103");
        final EventName name2 = new EventName("コミケ103");
    ...
    void testEquivalentToDifferent() {
        final EventName name1 = new EventName("コミケ103");
        final EventName name2 = new EventName("M3-2024春");
    ...
    void testEquivalentToNull() {
        final EventName name = new EventName("コミケ103");
    ...
    void testEquality() {
        final EventName name1 = new EventName("コミケ103");
        final EventName name2 = new EventName("コミケ103");
        final EventName name3 = new EventName("M3-2024春");

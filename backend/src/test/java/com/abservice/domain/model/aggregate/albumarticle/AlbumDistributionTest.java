...
class AlbumDistributionTest {
    ...
    class ChangePhysicalPriceTest {
        ...
        void changePhysicalPriceShouldSucceed() {
            ...
            // Act
            final var updated = distribution.changePhysicalPrice(newPrice);
    ...
    class ChangeDownloadPriceTest {
        ...
        void changeDownloadPriceShouldSucceed() {
            ...
            // Act
            final var updated = distribution.changeDownloadPrice(newPrice);
    ...
    class ChangeDemoUrlTest {
        ...
        void changeDemoUrlShouldSucceed() {
            ...
            // Act
            final var updated = distribution.changeDemoUrl(newUrl);
    ...
    class ChangeNoteTest {
        ...
        void changeNoteShouldSucceed() {
            ...
            // Act
            final var updated = distribution.changeNote(newNote);
    ...
    class IntegrationScenarioTest {
        ...
        void gradualSetupShouldSucceed() {
            ...
            final var step2 = step1.changeDownloadPrice(Price.of(500));
            final var step3 = step2.changeDemoUrl(Url.of("https://demo.example.com"));
            final var step4 = step3.changeNote("イベント頒布開始");

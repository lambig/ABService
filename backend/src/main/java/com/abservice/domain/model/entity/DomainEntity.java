 ...
 * <p>エンティティの状態変更は<strong>Lombok {@code @With}アノテーション</strong>を使用して
 * 不変更新（immutable update）を実現します。Setterの使用は禁止です。</p>
 *
 * <p><strong>重要</strong>: {@code @With}で生成されるwitherメソッドは{@code private}にし、
 * 業務的な意味を持つpublicメソッド内で使用してください。</p>
 *
 * <pre>{@code
 ...
 *     public void setCatalogNumber(String catalogNumber) { this.catalogNumber = catalogNumber; }  // Setter禁止
 * }
 * }</pre>
 *
 * <h2>等価性</h2>

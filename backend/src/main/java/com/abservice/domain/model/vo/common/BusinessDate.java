 ...
 *
 * <p>
 * システム全体で使用するビジネス日付を表現する値オブジェクト。
 * 内部表現は{@link LocalDate}を使用し、ビジネスタイムゾーン（Asia/Tokyo）での日付を表す。
 * </p>
 *
 * <h2>使用方法</h2>
 * <ul>
 ...
 * <h2>タイムゾーン</h2>
 * <p>
 * ビジネスタイムゾーンは{@code Asia/Tokyo}固定。
 * {@link BusinessDateTime#BUSINESS_ZONE_ID}として明示的に定義されている。
 * </p>
 *
 * <h2>インスタンス生成方法</h2>
 * <p>

 ...
 * </p>
 *
 * @see <a href="https://github.com/lambig/ABService/blob/main/docs/CODING_GUIDELINES.md">参考: ABService CODING_GUIDELINES</a>
 */
@MappedSuperclass
public abstract class AuditableEntity {
     ...
     * レコード作成日時
     * <p>
     * データベースのDEFAULT値により自動設定されるため、
     * アプリケーションコードで明示的に設定する必要はありません。
     * </p>
     */
